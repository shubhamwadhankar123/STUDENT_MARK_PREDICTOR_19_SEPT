...
if __name__ == "__main__":
    # Run the app on all available IPs (0.0.0.0) and set the desired port
    app.run(host='0.0.0.0', port=5001)
    # http://192.168.6.114:5001/    :- this will run on adcc server with their ip address as 192.168.6.114  with port as 5001.
